...
<body <?php body_class($custom_class); // call the WP function to create a class for each body on each page ?>>
	<header>
				...
				<div class="icon-inner-wrapper">
					<?php
						...
						if(get_theme_mod('twitter_link') != ''):
							echo '<a class="header-icon nav-text" href="' . get_theme_mod('twitter_link') . '"><i class="fa fa-twitter" aria-hidden="true"></i></a>';
						endif;
						if(get_theme_mod('instagram_link') != ''):
							echo '<a class="header-icon nav-text" href="' . get_theme_mod('instagram_link') . '"><i class="fa fa-instagram" aria-hidden="true"></i></a>';
						endif;
						if(get_theme_mod('linkedin_link') != ''):
							echo '<a class="header-icon nav-text" href="' . get_theme_mod('linkedin_link') . '"><i class="fa fa-linkedin" aria-hidden="true"></i></a>';
						endif;
					?>
				</div>
			</div>
		...
		<div class="logo-wrapper primary-color">
